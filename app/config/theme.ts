...
const Fonts = {
  light: 'FontAwesome', // 'Roboto-Light',
  regular: 'FontAwesome', //'Roboto-Regular',
  bold: 'FontAwesome', //'Roboto-Medium',
  logo: 'FontAwesome', //'Righteous-Regular',
};
